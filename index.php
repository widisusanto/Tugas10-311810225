<html>
   ...
   <body>
    ...
    <input type="varchar" name="No_Pelanggan" placeholder="No Pelanggan">
    <input type="varchar" name="Pengirim" placeholder="Pengirim">
         ...
         <tbody>
            <tr>
               ...
               <td><?php echo $row['Pengirim'] ?></td>
                <td><a href="update.php?No_Pelanggan=<?php echo $row['No_Pelanggan'] ?>">Update</a></td>
               <td><a href="delete.php?No_Pelanggan=<?php echo $row['No_Pelanggan'] ?>"
